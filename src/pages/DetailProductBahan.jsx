        ...
        <div className="bg-[#fff2d7] flex flex-row justify-center w-full">
            <div className="bg-[#fff2d7] overflow-hidden w-[1440px] h-[2298px] relative">
                ...
                <div className="flex flex-col w-[918px] items-start gap-2.5 absolute top-[576px] left-28">
                    ...
                    Kembang kol adalah sayuran yang terkenal dengan penampilannya yang unik, terdiri dari kepala bunga yang padat dan daun-daun yang mengerucut. Sebagai bagian dari keluarga kubis-kubisan, kembang kol memiliki tekstur yang renyah dan rasa yang manis.
                    </p>
                </div>
